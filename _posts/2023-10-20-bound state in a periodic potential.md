...
Here $$\mathbf{R}$$ is the lattice vector and $$N$$ is the number of primitive
...
lower energy the ansatz state possesses. As we mentioned above, the optimal localized
Wannier function is related to the quantum metric which is gauge independent. 

Furthermore, due to the localized property of the Wannier function, the
